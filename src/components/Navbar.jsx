  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="mobile-menu"
          className={`overflow-hidden border-t border-stone-dark bg-white transition-all duration-300 lg:hidden ${
            ...
            {links.map((link) =>
              link.to === '/' ? (
                <a
                  ...
                  href={`${import.meta.env.BASE_URL}`}
                  onClick={goHome}
                  className={`border-b border-stone-dark/70 py-3.5 text-sm uppercase tracking-[0.14em] ${
