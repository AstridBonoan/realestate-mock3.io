...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="relative z-20 mx-auto flex h-[4.5rem] max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
        <Link
          to="/"
          onClick={goHome}
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            className="relative z-30 inline-flex h-10 w-10 items-center justify-center border border-navy/15 text-navy transition-colors hover:border-navy/30 lg:hidden"
            aria-expanded={open}
      ...
      {/* Full-screen mobile menu — no body scroll lock */}
      <div
        id="mobile-menu"
        className={`fixed inset-0 z-10 bg-white transition-transform duration-300 ease-out lg:hidden ${
